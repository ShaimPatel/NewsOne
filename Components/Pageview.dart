...
class PageViewScreen extends StatefulWidget {
  NewsApiModal news;
  String nextnews;
  PageViewScreen({Key? key, required this.news, required this.nextnews})
      : super(key: key);
    ...
    return (widget.news.description.isNotEmpty)
        ? GestureDetector(
            onHorizontalDragStart: (details) =>
              ...
              builder: (context) => WebScreen(news: widget.news),
            )),
            child: Hero(
              tag: widget.news,
              child: Card(
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      onPressed: () => Share.share(
                                        widget.news.pageurl,
                                        subject:
                                            'Look what i know from NewsOne App',
                                      ),
        ...
        : CachedNetworkImage(
            imageUrl: "https://cdn-icons-png.flaticon.com/512/1801/1801044.png",
            fit: BoxFit.cover,
          );
  }
}
